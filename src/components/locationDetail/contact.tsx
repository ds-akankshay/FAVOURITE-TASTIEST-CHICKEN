  ...
  return (
    <>
      <div className="address-main-sec">
        <h4 className="box-title">{c_storeInfoHeading?c_storeInfoHeading:"STORE INFO"}</h4>
        <hr className="dark"style={{color:"red" ,marginBottom:"20px"}} />
        ...
        <div className="hours">
          <div className="hours-sec">
            <div className="title-with-link-1">
              <h4 className="box-title">{"STORE TIMING"}</h4>
